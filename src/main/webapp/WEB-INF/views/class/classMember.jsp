...
<form action="${home }class/ClassCreate" method="post">
<table>


	<tr>
	<br/><br/><br/>
		<td align='right'  height=40>클래스명</td>
		<td  colspan="3">
			<input   type=text id="classname"  name='classname' placeholder='클래스명 입력' style="width: 475px;"  /> 
		</td>
	...
	<tr>
		...
		<td>
	<select id="select1" name="cgenre" onchange="itemChange()">
    <option ></option>
    ...
    <option value="재테크">재테크</option>
		...
		<td>
			<select id="select2" name="cdetailgenre"  ></select> 
		</td>
	</tr>
	<tr>
		<td align='right' height=40>지역</td>
		<td colspan="2" >
			<input type=text name='ccity' placeholder='지역 입력'  style="width: 300px;" /> 
		</td>
	</tr>
	
	<tr>
		<td align='right'>클래스 유형</td>
		
		<td>
		&nbsp&nbsp&nbsp
			<input type=radio name='conline' value=1 /> 온라인
		</td>
		<td></td>
		<td>
			<input type=radio name='conline' value=0 />오프라인
		</td>
		
	</tr>

	<tr>
		<td align='right'>비용</td>
		<td colspan="3">
	...
	<tr>
		<td align='right'>클래스 설명</td>
			<td  colspan="3" >
		<textarea name="contents" style="width: 475px; height:100px"></textarea></td>
	</tr>
	
	<tr>
			<td align='right'>클래스 준비물</td>
			<td colspan="3"><input type=text name='Cmaterials' id='Cmaterials'  style="width: 100px; "/> 
		</td></tr>
